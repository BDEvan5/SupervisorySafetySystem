...
def get_moving_avg(vehicle_name, show=False):
    path = 'PaperData/Vehicles/' + vehicle_name + "/training_data.csv"
    smoothpath = 'PaperData/Vehicles/' + vehicle_name + f"/TrainingData.csv"
    rewards = []
...
get_moving_avg('Baseline_cthRef_8_0', True)